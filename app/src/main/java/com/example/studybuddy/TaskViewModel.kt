...
class TaskViewModel: ViewModel() {
    private val outfits = listOf(
        ...
        Outfit(R.drawable.hatone,R.drawable.hatoverlayone,"greenHat"),Outfit(R.drawable.shirtone,R.drawable.shirtoverlayone,"magicShirt"),Outfit(R.drawable.jacketone,R.drawable.jacketoverlayone,"redJacket"),)
    ...
    val tasks: LiveData<MutableList<Task>>
        get()= _tasks
    private val _achievementList: MutableLiveData<List<Achievement>> = MutableLiveData(listOf(Achievement("Getting Started","Complete 1 Task",false,outfits[8]),Achievement("It's a Start","Complete 10 Task",false,outfits[9]),Achievement("Progress","Complete 20 Task",false,outfits[10])))
    ...
    private val fit = mutableListOf(outfits[0],outfits[4],Outfit(0,0,"empty"),Outfit(0,0,"empty"),Outfit(0,0,"empty"),Outfit(0,0,"empty"))
    var stop = true
